...
namespace phm
{
	...
	void PointLightSystem::renderObjects(const FrameInfo& frameInfo, const VkDescriptorSet* const descriptorSet, const uint32_t activeLights) const
	{
		...
		vkCmdDraw(frameInfo.commandBuffer, 6 * activeLights, 1, 0, 0);
	}
}
